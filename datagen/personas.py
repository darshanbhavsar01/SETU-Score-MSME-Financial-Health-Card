...
PERSONAS: list[PersonaConfig] = [
    ...
    PersonaConfig(
        ...
        monthly_growth_mean=-0.030,
        monthly_growth_std=0.012,
        turnover_noise=0.08,
        gst_late_prob=0.10,
        gst_late_prob_drift=0.012,   # lateness worsens over the window
        num_payers=16,
        ...
        emi_to_inflow=0.24,
        supplier_ratio=0.46,
        liquidity_buffer_months=5.0,
        base_employees=12,
        employee_growth=-0.012,
        epfo_late_prob=0.18,
        expected_band="WATCH",
        expected_score_min=350,
